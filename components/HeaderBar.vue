      ...
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-2 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            <span class="sr-only">Mushy Match</span>
        ...
        <PopoverGroup class="hidden lg:flex lg:gap-x-12">
          <Popover class="relative">
            <PopoverButton class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-stone-400">
              Product
          ...
          <a href="#" class="text-sm font-semibold leading-6 text-stone-400">News</a>
          <a href="#" class="text-sm font-semibold leading-6 text-stone-400">About Us</a>
          <a href="#" class="text-sm font-semibold leading-6 text-stone-400">Contact</a>
        </PopoverGroup>
      </nav>
