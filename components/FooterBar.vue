    ...
    <footer class="flex justify-center w-full desktop:hidden fixed bottom-0 left-0 right-0 bg-white text-center border-2 z-50">
        ...
        <div class="w-11/12 left-0 right-0">
            <div class="flex justify-between w-full left-0 right-0 mx-auto py-4">
                <nuxt-link to="/" tag="div" class="quick-link">
                ...
                <div @click="emitDiscover" class="quick-link" data-cy="discover">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                    </svg>
                    <p>Discover</p>
                    <!-- <button @click="emitDiscover">Discover</button> -->
                </div>
                
                <nuxt-link to="/about" tag="div" class="quick-link" data-cy="about">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" class="w-6 h-6 ">
                ...
                <nuxt-link to="/news" tag="div" class="quick-link">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" class="w-6 h-6">
                ...
                <nuxt-link to="/contact" tag="div" class="quick-link">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" class="w-6 h-6">
